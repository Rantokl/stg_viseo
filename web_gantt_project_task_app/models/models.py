...
class Base(models.AbstractModel):
    ...
    def _get_default_ganttt_view(self):
        ...
        """
        view = E.ganttt(string=self._description)
        ...
        for name in ganttt_field_names.keys():
            if getattr(self, name) not in self._fields:
                for dt in ganttt_field_names[name]:
    ...
    # @api.model
    # def ganttt_unavailability(self, start_date, end_date, scale, group_bys=None, rows=None):
    #     """
    ...
    #     Example:
    #         * start_date = 01/01/2000, end_date = 01/07/2000, scale = 'wstage_ideek',
    #           rows = [{
